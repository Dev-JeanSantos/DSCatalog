...
test('should render ButtonIcon', () => {
    ...
    const secundPageItem = screen.getByText('2');
    ...
    expect(secundPageItem).toBeInTheDocument();
    expect(secundPageItem).not.toHaveClass('page-active');
    expect(thirdPageItem).toBeInTheDocument();
    expect(thirdPageItem).not.toHaveClass('page-active');
});
...
test('shoul trigger onchange action', () =>{
